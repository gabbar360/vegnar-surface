  ...
  const features = [
    {
      ...
      description: "We are the top manufacturer because of our on-time and secure deliveries. You can be certain that when you work with us, your cargo will arrive on schedule, undamaged, and in the best possible shape.",
      image: "https://images.unsplash.com/photo-1566576912321-d58ddd7a6088?w=600"
    },
    {
      icon: Package,
      title: "Extensive Product Line", 
      description: "Vegnar Ceramic is aware everybody has different tastes. To satisfy the various needs of our customers, we provide a varied and distinctive range of tiles and sanitaryware products.",
      image: "https://images.unsplash.com/photo-1560472354-b33ff0c44a43?w=600"
    },
    {
      icon: Award,
      title: "Excellent Quality",
      description: "We utilize cutting-edge technologies and maintain international standards throughout the whole manufacturing and testing process to guarantee that our goods are of the highest quality.",
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="text-center mb-16">
          ...
          <p className="section-subtitle max-w-3xl mx-auto">
            We distinguish ourselves from other tile manufacturers through our commitment 
                  ...
                  {index === 0 && (
                    <>
                      <div className="text-center">
                        <div className="text-3xl font-bold text-gold mb-2">99.5%</div>
                        <div className="text-sm text-muted-foreground">On-Time Rate</div>
                      </div>
                      <div className="text-center">
                        <div className="text-3xl font-bold text-gold mb-2">22+</div>
